...
public interface CodaFatturazioneMapper {
     ...
     * @mbggenerated Tue Apr 15 21:14:28 CEST 2014
     */
    int updateByExampleSelective(@Param("record") CodaFatturazione record, @Param("example") CodaFatturazioneExample example);
     ...
     * @mbggenerated Tue Apr 15 21:14:28 CEST 2014
     */
    int updateByExample(@Param("record") CodaFatturazione record, @Param("example") CodaFatturazioneExample example);

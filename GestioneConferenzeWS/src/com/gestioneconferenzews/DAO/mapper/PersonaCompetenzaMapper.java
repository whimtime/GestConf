...
public interface PersonaCompetenzaMapper {
     ...
     * @mbggenerated Tue Mar 18 22:26:00 CET 2014
     */
    int updateByExampleSelective(@Param("record") PersonaCompetenza record, @Param("example") PersonaCompetenzaExample example);
     ...
     * @mbggenerated Tue Mar 18 22:26:00 CET 2014
     */
    int updateByExample(@Param("record") PersonaCompetenza record, @Param("example") PersonaCompetenzaExample example);

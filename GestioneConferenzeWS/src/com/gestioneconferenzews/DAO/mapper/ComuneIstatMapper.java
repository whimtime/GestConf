...
public interface ComuneIstatMapper {
     ...
     * @mbggenerated Tue Mar 11 22:24:43 CET 2014
     */
    int updateByExampleSelective(@Param("record") ComuneIstat record, @Param("example") ComuneIstatExample example);
     ...
     * @mbggenerated Tue Mar 11 22:24:43 CET 2014
     */
    int updateByExample(@Param("record") ComuneIstat record, @Param("example") ComuneIstatExample example);
